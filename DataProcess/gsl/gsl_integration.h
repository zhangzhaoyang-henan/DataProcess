...
GSL_FUN gsl_integration_lebedev_workspace * gsl_integration_lebedev_alloc(const size_t n);

GSL_FUN void gsl_integration_lebedev_free(gsl_integration_lebedev_workspace * w);

GSL_FUN size_t gsl_integration_lebedev_n(const gsl_integration_lebedev_workspace * w);
