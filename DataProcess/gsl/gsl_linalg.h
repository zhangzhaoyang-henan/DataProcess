...
GSL_FUN int gsl_linalg_QR_lssolvem_r (const gsl_matrix * QR, const gsl_matrix * T,
...
GSL_FUN int gsl_linalg_complex_QR_lssolvem_r (const gsl_matrix_complex * QR, const gsl_matrix_complex * T,
...
GSL_FUN int gsl_linalg_complex_QR_QHmat_r(const gsl_matrix_complex * QR, const gsl_matrix_complex * T,
...
GSL_FUN int gsl_linalg_QR_UD_lssvx (const gsl_matrix * R, const gsl_matrix * Y, const gsl_matrix * T,
                            gsl_vector * x, gsl_vector * work);

GSL_FUN int gsl_linalg_QR_UD_QTvec(const gsl_matrix * Y, const gsl_matrix * T, gsl_vector * b, gsl_vector * work);

/* triangle on top of rectangle QR decomposition */

GSL_FUN int gsl_linalg_QR_UR_decomp (gsl_matrix * S, gsl_matrix * A, gsl_matrix * T);

GSL_FUN int gsl_linalg_QR_UR_lssolve (const gsl_matrix * R, const gsl_matrix * Y, const gsl_matrix * T,
                              const gsl_vector * b, gsl_vector * x, gsl_vector * work);

GSL_FUN int gsl_linalg_QR_UR_lssvx (const gsl_matrix * R, const gsl_matrix * Y, const gsl_matrix * T,
                            gsl_vector * x, gsl_vector * work);

GSL_FUN int gsl_linalg_QR_UR_QTvec(const gsl_matrix * Y, const gsl_matrix * T, gsl_vector * b, gsl_vector * work);
...
GSL_FUN int gsl_linalg_QR_UU_lssvx (const gsl_matrix * R, const gsl_matrix * Y, const gsl_matrix * T,
                            gsl_vector * x, gsl_vector * work);
