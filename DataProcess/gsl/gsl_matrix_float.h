...
GSL_FUN int gsl_matrix_float_scale (gsl_matrix_float * a, const float x);
...
GSL_FUN int gsl_matrix_float_add_constant (gsl_matrix_float * a, const float x);
GSL_FUN int gsl_matrix_float_add_diagonal (gsl_matrix_float * a, const float x);
