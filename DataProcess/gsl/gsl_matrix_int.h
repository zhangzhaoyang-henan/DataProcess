...
GSL_FUN int gsl_matrix_int_scale (gsl_matrix_int * a, const int x);
...
GSL_FUN int gsl_matrix_int_add_constant (gsl_matrix_int * a, const int x);
GSL_FUN int gsl_matrix_int_add_diagonal (gsl_matrix_int * a, const int x);
