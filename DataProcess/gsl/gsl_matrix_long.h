...
GSL_FUN int gsl_matrix_long_scale (gsl_matrix_long * a, const long x);
...
GSL_FUN int gsl_matrix_long_add_constant (gsl_matrix_long * a, const long x);
GSL_FUN int gsl_matrix_long_add_diagonal (gsl_matrix_long * a, const long x);
