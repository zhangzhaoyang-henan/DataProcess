...
GSL_FUN int gsl_matrix_uchar_scale (gsl_matrix_uchar * a, const unsigned char x);
...
GSL_FUN int gsl_matrix_uchar_add_constant (gsl_matrix_uchar * a, const unsigned char x);
GSL_FUN int gsl_matrix_uchar_add_diagonal (gsl_matrix_uchar * a, const unsigned char x);
