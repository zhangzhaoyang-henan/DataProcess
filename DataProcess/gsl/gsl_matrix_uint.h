...
GSL_FUN int gsl_matrix_uint_scale (gsl_matrix_uint * a, const unsigned int x);
...
GSL_FUN int gsl_matrix_uint_add_constant (gsl_matrix_uint * a, const unsigned int x);
GSL_FUN int gsl_matrix_uint_add_diagonal (gsl_matrix_uint * a, const unsigned int x);
