...
GSL_FUN int gsl_sf_legendre_precompute(const gsl_sf_legendre_t norm, const size_t lmax,
                               const size_t flags, double output_array[]);
GSL_FUN size_t gsl_sf_legendre_array_n(const size_t lmax);
GSL_FUN int gsl_sf_legendre_arrayx(const gsl_sf_legendre_t norm, const size_t lmax,
                           const double x, double result_array[]);
GSL_FUN int gsl_sf_legendre_deriv_alt_arrayx(const gsl_sf_legendre_t norm, const size_t lmax,
                                     const double x, double result_array[], double result_deriv_array[]);
GSL_FUN int gsl_sf_legendre_deriv_arrayx(const gsl_sf_legendre_t norm, const size_t lmax,
                                 const double x, double result_array[], double result_deriv_array[]);
GSL_FUN int gsl_sf_legendre_deriv2_alt_arrayx(const gsl_sf_legendre_t norm, const size_t lmax,
                                      const double x, double result_array[],
                                      double result_deriv_array[], double result_deriv2_array[]);
GSL_FUN int gsl_sf_legendre_deriv2_arrayx(const gsl_sf_legendre_t norm, const size_t lmax,
                                  const double x, double result_array[],
                                  double result_deriv_array[], double result_deriv2_array[]);
...
GSL_FUN INLINE_DECL size_t gsl_sf_legendre_nlm(const size_t lmax);
GSL_FUN INLINE_DECL size_t gsl_sf_legendre_array_index(const size_t l, const size_t m);
GSL_FUN INLINE_DECL size_t gsl_sf_legendre_array_index_m(const size_t l, const size_t m, const size_t lmax);
