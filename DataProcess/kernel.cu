...
{
	//std::string fnamePhase = "C:\\code\\phaseform\\Data\\gongkong.txt";
	std::string fnamePhase = "F:\\DATA\\PhaseCalibration_C04_old.txt";
	//std::string fnamePhase = "F:\\DATA\\gongkong.txt";
	std::string fnameBg;
	...
	if (argc == 1)
	{
		...
		fnameData = "F:\\DATA\\使用匹配膏_01无_02有\\M0008_2022_P0000002_circle_3.0x3.1_C7_S7.bin";
